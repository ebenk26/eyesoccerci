...
<div id="player_reg" class="modal fade" role="dialog">
  <div class="modal-dialog" id="set7">
    ...
    <div class="modal-header text-center"><h1 id="t3">Daftar Sebagai Pemain</h1></div>
      <div class="modal-body">
      <form method="post" action="<?=base_url("home/request_player")?>">
	  <small>Sudah terdaftar di database kami? Verifikasi diri anda sekarang !</small>
      <div class="form-group" id="t1"><select name="player_id" data-style="btn-success" data-live-search="true" class="selectpicker form-control">
	  <option value="" style="color:white">Pilih Pemain</option>
	  <?php
	  $player=$this->db->query("SELECT a.*,b.name as club_name FROM tbl_player a LEFT JOIN tbl_club b ON b.club_id=a.club_id WHERE a.member_id='0' ORDER BY a.name ASC ");
